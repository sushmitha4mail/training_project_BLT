...
public class Contact_TestCase  extends WrapperClass{
	...
	@Given("^the user launch the application and login with (.+) , (.+) into the application$")
	...
	public void enter_email() {
		contact_Page.contact_Email("kokatamtriveni98@gmail.com");
		
	}
	@Then("^the user enters contact name$")
	public void enter_Name() {
		contact_Page.contact_Name("Triveni reddy");
	...
	@Given("^if user launch the application and login with (.+) , (.+) into the application and$")
...
////entering all details and clicking submit button/////////////////////////////////////
	@Given("^might the user launch the application and login with (.+) , (.+) into the application$")
	...
	public void contact2() throws InterruptedException {
		click_Contact();	
	}
	...
	public void messagee() throws InterruptedException {
